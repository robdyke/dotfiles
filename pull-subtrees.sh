...
git subtree pull -m 'update subtree' --squash --prefix=home/.vim/bundle/javascript-syntax https://github.com/jelera/vim-javascript-syntax.git master
...
git subtree pull -m 'update subtree' --squash --prefix=home/.vim/bundle/vim-ansible-yaml https://github.com/chase/vim-ansible-yaml.git master
...
git subtree pull -m 'update subtree' --squash --prefix=home/.vim/bundle/vim-toml https://github.com/cespare/vim-toml.git master
